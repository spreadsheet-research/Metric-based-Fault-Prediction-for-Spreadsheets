...
def GSandEvaluateCrossDatasetEnsembleClassifier(trainDataset, testDataset, model, param_grid, exportPath, exportName, scoring=None, sampler=None):
    ...
    res, estimator = core.compareCrossDatasetEnsembleCategorizationPerformance(trainDataset, testDataset, pipeline, param_grid, model, scoring)
...
#SMALL
smallPath = '../../metric_data/ENRON_errors_2017-08-01T15-41/cells_small.csv'
smallName = 'SMALL'
...
trainDataset = secondDataset
testDataset = secondDataset
...
exportPath = "../../results/2019-04/transferlearning_experiments"
exportName = "transferlearning_"+trainDataset.name+"_"+testDataset.name

GSandEvaluateCrossDatasetEnsembleClassifier(trainDataset, testDataset, model, param_grid, exportPath, exportName)
