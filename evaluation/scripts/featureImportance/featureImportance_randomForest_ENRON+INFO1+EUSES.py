...
tempName = enronName + "+" + info1Name
tempDataset = data.combineDatasets(enronDataset, info1Dataset, tempName)

dataName = tempName + "+" + eusesName
dataset = data.combineDatasets(tempDataset, eusesDataset, dataName)
