...
Output of the evaluation is assumed to be on the same folder hierarchy in the results folder (e.g. '../../results/study2')
Can be adapted by the line "exportPath = '../../results/study2'"