Scripts to evaluate the prediction performance of individual metrics.
...
Output of the evaluation is assumed to be on the same folder hierarchy in the results folder (e.g. '../../results/study1')
Can be adapted by the line "exportPath = '../../results/study1'"